...
const Service = [
  {
    ...
    description: "Creating visulllay appealing and user-friendly web designs.",
  },

  {
    id: 2,
    title: "Frontend Development",
    description: "Building reponsive and intractive user interfaces.",
  },
...

  {
    ...
    description: "Promote your bussiness with our digital marketing team.",
  },
];
const MyServices = () => {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {Service.map((service) => (
            <div key={service.id} className="bg-gray-800 px-6 pb-6 rounded-lg hover:shadow-lg transform transition-transform duration-300 hover:scale-105">
                <div className="text-right text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-500 to to-blue-400">
                    {service.id}
                </div>
